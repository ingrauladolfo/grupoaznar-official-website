...
export const HeroEquipacionCocinaWrapper = styled.section`
  text-align: center;
  padding: 50px 0;
  background-color: #fffefc;
`;

export const HeroEquipacionCocinaContentWrapper = styled.div`
  display: flex;
...
export const HeroEquipacionCocinaItem = styled.div`
...
`;
export const HeroEquipacionCocinaTitle = styled.h2`
  font-size: 3rem;
  color: #1e1e1e;
  margin: 0 auto;
  padding: 50px;
...
export const HeroEquipacionCocinaStyledImage = styled.img`
  width: 75%;
  height: auto;
  margin: 25px auto;
`;
export const HeroEquipacionCocinaText = styled.p`
  font-size: 2rem;
  color: #1e1e1e;
  margin: 0 auto;
`;
