...
export const AboutHeroServiciosTecnicosWrapper = styled.section`
  text-align: center;
  padding: 50px 0;
...
export const AboutHeroServiciosTecnicosItem = styled.div`
...
export const AboutHeroServiciosTecnicosStyledImage = styled.img`
  width: 75%;
  height: auto;
`;
export const AboutHeroServiciosTecnicosText = styled.p`
  font-size: 2rem;
  color: #1e1e1e;
  margin: 0 auto;
`;
