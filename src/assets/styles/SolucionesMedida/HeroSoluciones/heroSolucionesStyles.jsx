...
export const HeroSolucionesWrapper = styled.section`
  text-align: center;
  padding: 50px 0;
...
export const HeroSolucionesItem = styled.div`
...
export const HeroSolucionesStyledImage = styled.img`
  width: 75%;
  height: auto;
`;
export const HeroSolucionesText = styled.p`
  font-size: 2rem;
  color: #1e1e1e;
  margin: 0 auto;
`;
