...
export const FooterHeroSolucionesWrapper = styled.section`
  text-align: center;
  padding: 50px 0;
...
export const FooterHeroSolucionesItem = styled.div`
...
export const FooterHeroSolucionesStyledImage = styled.img`
  width: 75%;
  height: auto;
`;
export const FooterHeroSolucionesText = styled.p`
  font-size: 2rem;
  color: #1e1e1e;
  margin: 0 auto;
`;
